...
function showz(){
    alert(document.getElementById("post-1").style.zIndex);
}
</script>
<body <?php body_class(); ?>>
<!-- tool bar -->
    ...
    <div class="toolbarinner">
		<div class="rightmenu">
			<ul id="menu-clientarea">
				<li><a href="clientarea.php" class="rightmenu myaccount">Client Area</a></li>
				<li><a href="register.php" class="rightmenu register">Register</a></li>			        
				<li><a href="contact.php" class="rightmenu contact">(866)560-9519 </a></li>          	
		    </ul>
        </div><!-- .rightmenu -->
	</div><!-- .toolbarinner -->
</div><!-- .toolbar -->
<div id="page" class="hfeed site">
    ...
    <div id="navbar" class="navbar">
        <nav>
            <ul>
                <li><a class="mainmenu" href="portal.php">Help</a></li>
                <li><a class="mainmenu" href="affiliate-program.php">Promote CloudURL</a></li>
                <li><a class="mainmenu" href="domainchecker.php">Domains</a></li>
                <li><a class="mainmenu" href="cart.php?a=add&amp;pid=4">WordPress Hosting</a></li>
                <li><a class="mainmenu" href="web-hosting.php">Web Hosting</a></li>
            </ul>
        </nav>
    </div>
    </header>
